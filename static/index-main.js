...
sel.multiple=true;sel.classList.add("chosen-select");sel.classList.add("thisone");document.getElementById("main").appendChild(sel);const duration=performance.now()-startTime;console.log(`fMain took ${duration}ms`);}
